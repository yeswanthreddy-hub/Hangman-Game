export const TOPICS = {
  ...
  space: {
    emoji: '🚀',
    name: 'Space',
    words: ['GALAXY', 'PLANET', 'ROCKET', 'COMET', 'ASTEROID', 'SATURN', 'NEBULA', 'METEOR', 'ASTRONAUT', 'ORBIT', 'SATELLITE', 'TELESCOPE', 'CONSTELLATION', 'MARS', 'VENUS', 'MERCURY', 'JUPITER', 'URANUS', 'COSMOS', 'GRAVITY'],
  },
  nature: {
    emoji: '🌿',
    name: 'Nature',
