export const TOPICS = {
  ...
  sports: {
    emoji: '⚽',
    name: 'Sports',
    words: ['SOCCER', 'BASKETBALL', 'TENNIS', 'HOCKEY', 'BOXING', 'SWIMMING', 'BASEBALL', 'GOLF', 'VOLLEYBALL', 'RUGBY', 'SKIING', 'CYCLING', 'ARCHERY', 'WRESTLING', 'CRICKET', 'FENCING', 'KARATE', 'ROWING', 'SKATEBOARD', 'BADMINTON'],
  },
  places: {
    emoji: '🏙️',
    name: 'Places',
